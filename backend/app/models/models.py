...
class Student(Base):
    ...
    voice_profile: Mapped["VoiceProfile | None"] = relationship(back_populates="student")
    persona_config: Mapped["PersonaConfig | None"] = relationship(back_populates="student")
    bindings: Mapped[list["Binding"]] = relationship(back_populates="student")
    materials: Mapped[list["ContextMaterial"]] = relationship(back_populates="student")
    notifications: Mapped[list["Notification"]] = relationship(back_populates="student")
    summaries: Mapped[list["ChatSummary"]] = relationship(back_populates="student")
...
class Parent(Base):
    ...
    bindings: Mapped[list["Binding"]] = relationship(back_populates="parent")
...
class Binding(Base):
    ...
    conversations: Mapped[list["Conversation"]] = relationship(back_populates="binding")
...
class Conversation(Base):
    ...
    id: Mapped[int] = mapped_column(Integer, primary_key=True)
    binding_id: Mapped[int] = mapped_column(ForeignKey("bindings.id"))
    created_at: Mapped[datetime] = mapped_column(DateTime(timezone=True), default=utcnow)
